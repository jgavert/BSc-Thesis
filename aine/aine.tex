...
\title{Välimuistiriippumattomat algoritmit}
...
kuuluu ihanteellinen välimuisti koostuen \(Z\) sanoista ja mielivaltaisen
kokoisesta päämuistista. Myös huomioitava, että välimuistin sanojen koko on
